...
import { WallSnap } from "@infrastructure/snap";
...
describe("WallSnap", () => {
    ...
    it("emite snapPointCalculated com ponto de interseção e tipo wall", () => {
        ...
        expect(payload.snappedPosition).toEqual(Vec3Factory.create(0, 0, -4.5));
        expect(payload.snapType).toBe("wall");
    });
